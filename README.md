...
| `DELETE` | <br><pre>`/daily_reports/{dailyreport_name}`</pre>          | `200 Successfully deleted`<br><br>`404 Daily Reports not found`                           | Delete a Daily Report<br><br>dailyreport_name*: `string`                                                                                                                                                                                                                                                                                                                                                                                                                           |## Examples
Time Series `POST`
```bash
